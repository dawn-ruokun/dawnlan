...
const add_id = "1lmjfifkjpqonprf"; // app_id
const app_secret = "c0E0UmgyaFQ5T2o3eVJsVUVmbGFnQT09"; // app_secret
const key = "b0c5f32fa0cc47db8747786544d6e96c" // key
function getWeather() {
...
$('#switchmore').on('click', function () {
    ...
    if (shoemore && $(document).width() >= 990) {
        ...
        $("#change").html("Oops&nbsp;!");
        $("#change1").html("右侧自定义壁纸等（ 再点击一次可关闭 ）");
    } else {
        $('#container').attr('class', 'container');
        $("#change").html("Hello&nbsp;BT-0207&nbsp;!");
        $("#change1").html("欢迎来到本网站，如有好的建议或想法，你可以通过下方的联系方式与我交谈");
    }
});
